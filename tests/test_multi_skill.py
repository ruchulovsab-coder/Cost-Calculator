...
def test_grade_eligibility_by_family():
    ...
    assert grade_eligibility("L1", "InfraOps") == ["2.1-INFRAOPS"]
    assert grade_eligibility("L1", "CloudOps") == ["2.1-CLOUD-INFRASTRUCTURE"]
    assert grade_eligibility("L2", "CloudOps") == ["2.2-CLOUD-INFRASTRUCTURE", "2.3-CLOUD-INFRASTRUCTURE"]
    assert grade_eligibility("L3", "CloudOps") == ["3.1-CLOUD-INFRASTRUCTURE", "3.2-CLOUD-INFRASTRUCTURE", "3.3-CLOUD-INFRASTRUCTURE"]
    ...
    assert grade_eligibility("L1") == ["2.1-INFRAOPS"]                          # default InfraOps
